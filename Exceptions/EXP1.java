    ...
    public class Solution {
        ...
        public static void main(String[] args) {
            try {
                ...
                BEAN.log(e); // логируем любые виды исключений
            }

        }

        public static void handleExceptions() throws FileSystemException { // эту дичь тоже надо было добавить
            try {
            ...
            catch (CharConversionException exp1) {
                BEAN.log(exp1);
            }
